        ...
        <div className="profile" style={{ maxWidth: "550px", margin: "0px auto" }}>
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        <img   style={{ marginTop: "30px", width: "90px", height: "140px", borderRadius: "80px" }}
                            src={state ? state.pic : "loading"} />
                    </div>
                    <div>
                        <h4 style={{ marginLeft: "20px" }}>{state ? state.name : "loading"}</h4>
                        <h5 style={{ marginLeft: "20px" }}>{state ? state.email : "loading"}</h5>
                        <div style={{ display: "flex", justifyContent: "space-between", width: "108%" }}>
                            <h6>{mypics.length} posts</h6>
                            <h6>{state.followers != undefined ? state.followers.length : "0"} followers</h6>
                            <h6 style={{marginRight:"3px"}}>{state.following != undefined ? state.following.length : "0"} following</h6>
                        </div>
                    </div>
                </div>
