    ...
    return(
        ...
        {userProfile ?
          ...
          <div style={{
              ...
              <div>
                 <img style={{ marginTop:"30px",width:"160px",height:"160px",borderRadius:"80px"}}
              ...
              <div>
                 ...
                 :<button style={{
                     margin:"10px"
                 }} className="btn waves-effect waves-light #64b5f6 blue darken-1" onClick={()=>unfollowUser()}>unFollow</button>}
              </div>
          </div>
